...
## Corrected time period annotation. Adding a pre-treatment, early, and late period.
...
### GSEA Heatmaps Early vs Pre-treatment
...
We use these 6 patients to run GSEA to compare the Early period 
...
knitr::include_graphics("Making Plots/Pathway heatmap Early vs Pre-Treatment - KEGG.png")
knitr::include_graphics("Making Plots/Pathway heatmap Early vs Pre-Treatment - REACTOME.png")
```

### GSEA Heatmaps Late vs Early
...
We use these 2 patients to run GSEA to compare the Late period 
...
```{r out.width="49%", out.height = "49%", fig.show='hold', fig.align='center', fig.cap=c("LEFT: KEGG ---- RIGHT: REACTOME")}
knitr::include_graphics("Making Plots/Pathway heatmap Early vs Late - KEGG.png")
knitr::include_graphics("Making Plots/Pathway heatmap Early vs Late - REACTOME.png")
```
